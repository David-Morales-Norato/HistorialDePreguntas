...
class robot_hist_pregunta(Robot):
    ...
    def tratamiento_curso(self,datos, variables_de_control):
        ...
        if(opcion == 1):
            ...
            actividad = datos[1][contador]
            resultados_de_actividades = [self.driver.find_element_by_link_text(str(actividad))]
            id_actividad = resultados_de_actividades[0].get_attribute('href').split('=')[1]
            href = "https://tic.uis.edu.co/ava/mod/quiz/report.php?id="+id_actividad+"&amp;mode=overview"
    ...
    def recorrer_preguntas(self, table, main_window, datos,variables_de_control, link_actividad):
        ...
        try: 
            ...
            for question in questions:
                ...
                respuestas = self.encontrar_respuestas(quest_id_title, variables_de_control[0])
    ...
    def encontrar_respuestas(self, title, tipo_de_tratamiento):
